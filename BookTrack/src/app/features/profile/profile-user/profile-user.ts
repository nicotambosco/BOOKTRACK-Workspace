...
@Component({
      ...
      <div class="content">
        <div class="card">
          <div class="avatar-area">
            ...
            @if (mostrarHistorial) {
              <button class="btn-historial" (click)="irAHistorial()">HISTORIAL ▲</button>
            } @else {
              <button class="btn-historial" (click)="irAHistorial()">HISTORIAL ▼</button>
            }
          </div>
  ...
  styles: [`
    ...
    .btn-historial { background:#1a1a1a; color:white; border:none; padding:0.3rem 0.8rem; border-radius:4px; cursor:pointer; font-size:0.75rem; }
...
export class ProfileUser implements OnInit {
  editando = false; exito = false; mostrarHistorial = false;
